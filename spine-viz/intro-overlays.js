...
const TEXT_SCHEDULE = [
  ...
  // 组 B：病理解释 (27-40s) - 分别定位在两段脊柱最突出的峰值处
  // 胸椎峰值在屏幕上半部（约 30%），向右凸 → 字幕放右侧
  // 腰椎峰值在屏幕下半部（约 70%），向左凸 → 字幕放左侧
  // 对角线布局，保证距离、避免相互覆盖
  { text: '凸起的那一侧，肋骨被撑得太开；',
    start: 27, group: 'B', pos: { top: '30%', left: '60%' } },
  { text: '凹陷的那一侧，肋骨被挤在一起。',
    start: 33, group: 'B', pos: { top: '72%', left: '8%' } },
